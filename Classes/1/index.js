...
// Замыкания 
// Функция созданная в замыкании запоминает 
// то окружение (контекст) в котором она была создана
// и она имеет доступ к перемнным этого контекста 

// при запуске функции создаётся новый контекст вызова 
// все перемнные создают лексическое окружение функции 
